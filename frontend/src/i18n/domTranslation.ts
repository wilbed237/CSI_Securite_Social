...
const frToEn: Record<string, string> = {
  ...
  'Se connecter': 'Sign in', 'Retour connexion': 'Back to sign in', 'Retour accueil': 'Back to home',
  'Accueil': 'Home', 'Connexion': 'Sign in',
  'Accédez à votre espace agent ou médecin.': 'Access your agent or doctor workspace.', 'Mot de passe': 'Password',
  'Email, téléphone ou utilisateur requis': 'Email, phone or username is required',
