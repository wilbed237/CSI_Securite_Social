...
export function InsuranceSettings({ settings }: { settings: SettingResponse[] }) {
  if (settings.length === 0) return <p className="text-sm text-slate-500">Aucune règle assurance configurée.</p>;
  return (
